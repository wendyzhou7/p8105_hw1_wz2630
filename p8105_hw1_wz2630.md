...
There are many missing data in variables wind_gust and pressure. \#
missing data or outliers. The variable time_hour observations are in
year, month, day, and hour; temp and humid variables are in continuous
numbers.
...
We cannot take the mean of character variables. We can only take the
mean of numerical value variables.
